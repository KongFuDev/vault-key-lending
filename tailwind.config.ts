  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { 
            ...
            borderColor: "hsl(200 100% 60% / 0.5)"
          },
          "50%": { 
            boxShadow: "0 0 30px hsl(200 100% 60% / 0.6)",
            borderColor: "hsl(200 100% 60% / 0.8)"
          },
        },
        "encrypt-glow": {
          "0%, 100%": { 
      ...
      animation: {
        ...
        "encrypt-glow": "encrypt-glow 3s ease-in-out infinite",
